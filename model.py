...
from config import gi, gf, df, channels 
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.e_conv_3 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=28, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2)),
            nn.Tanh()
        )
    def forward(self, x):
        ec1 = self.e_conv_1(x)
...
#         )
        ...
        nn.Conv2d(in_channels=28, out_channels=64, kernel_size=(3, 3), stride=(1, 1)),
            nn.LeakyReLU(),
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.latent_layer1 = nn.Sequential(
            nn.ConvTranspose2d(28, 12, (3,3), stride=1, padding=0, output_padding=0, groups=1, bias=True, dilation=1),
